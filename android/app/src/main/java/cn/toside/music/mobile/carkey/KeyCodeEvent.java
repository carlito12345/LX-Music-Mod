...
public class KeyCodeEvent implements Parcelable {
    ...
    public static final Parcelable.Creator<KeyCodeEvent> CREATOR = new Parcelable.Creator<KeyCodeEvent>() { // from class: cn.toside.music.mobile.carkey.KeyCodeEvent.1
