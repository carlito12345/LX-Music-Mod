...
import cn.toside.music.mobile.carkey.ServiceConnectionListener;
...
class ServiceConnectionManager {
    ...
    private final ServiceConnection mServiceConnection = new ServiceConnection() { // from class: cn.toside.music.mobile.carkey.ServiceConnectionManager.1
    ...
    private class ServiceManagerCallback extends IServiceManagerCallback.Stub {
        ...
        @Override // cn.toside.music.mobile.carkey.IServiceManagerCallback
