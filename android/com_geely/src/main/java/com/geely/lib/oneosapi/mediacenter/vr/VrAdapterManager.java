...
import com.geely.lib.oneosapi.mediacenter.manager.MediaAdapterManager;

/* loaded from: classes.dex */
public class VrAdapterManager extends MediaAdapterManager {
    private static final String TAG = "VrAdapterManager";
