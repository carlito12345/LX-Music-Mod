...
public class MediaAdapterManager extends MusicAdapterManager {
    ...
    static /* synthetic */ class C05541 {
        ...
        static final /* synthetic */ int[] f60xcbf1b1f7;
        ...
        static {
            ...
            try {
                f60xcbf1b1f7[MediaCenterConstant.AudioSource.AUDIO_SOURCE_RADIO.ordinal()] = 2;
    ...
    public int playFavor() {
        int i = C05541.f60xcbf1b1f7[getCurrentAudioSource().ordinal()];
        if (i == 1) {
    ...
    public int playRadioFavor() {
        if (C05541.f60xcbf1b1f7[getCurrentAudioSource().ordinal()] != 2) {
            return -1;
        }
    ...
    public int openLrcPage() {
        if (C05541.f60xcbf1b1f7[getCurrentAudioSource().ordinal()] != 1) {
            return -1;
        }
